...
# start the engine and commit the changes by exiting
with engine.connect() as connection:
    ...
    insert_statement = sales_table.insert().values(order_num=1105910, order_type='Retail', cust_name='Syman Mapstone',
                                                   prod_number='EB521',
