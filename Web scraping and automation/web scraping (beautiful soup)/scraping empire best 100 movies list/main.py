...
# print(soup.prettify())
# int the response we find (by looking up any number between 1 and 100; since the movies are ranked in this way)
...
# print(data)
titles_indices = []
#here  i use pattern matching to find the movies title_index, since the common attribute is "titleText":" followed by the movie
# number and name
