...
songs_names = [song_name.text for song_name in
               soup.find_all("span", class_="chart-element__information__song text--truncate color--primary")]
singers_names = [singer_name.text for singer_name in
...
# for verification purposes copy the url of the example page you get redirected to and past in in the console
