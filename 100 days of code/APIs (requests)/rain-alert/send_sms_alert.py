...
TWILIO_SENDER_NUMBER = os.environ["TWILIO_SENDER_NUMBER"]  # Twilio provided "sender" number
TWILIO_VERIFIED_RECEIVER_NUMBER = os.environ[
...
if will_rain:
    ...
    send_message = client.messages \
        .create(body="It's going to rain today, Remember to take an Umbrella ☂️.",
