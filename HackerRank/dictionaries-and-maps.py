...
#
# Input Format
# The first line contains an integer,n , denoting the number of entries in the phone book. Each of the n subsequent
# lines describes an entry in the form of 2 space-separated values on a single line. The first value is a friend's
...
# 1<=queries<=10**5
# Output Format #
# On a new line for each query, print Not found if the name
# has no corresponding entry in the phone book; otherwise, print the full name and phone number in the format
# name=phoneNumber.
#
# Sample Input
#
